              ...
              <ul class="socials__ul">
                <li class="socials__li socials__li--mobile">
                  <a
                    class="socials__link"
                    target="_blank"
                    href="https://www.facebook.com/vladis.vaisov"
                  >
                    <svg
                      height="30px"
                      viewBox="0 0 512 512"
                ...
                <li class="socials__li socials__li--mobile">
                  <a
                    class="socials__link"
                    target="_blank"
                    href="https://www.linkedin.com/in/vladimir-vaisov"
                  >
                    <svg
                      height="512pt"
                      viewBox="0 0 512 512"
                ...
                <li class="socials__li socials__li--mobile">
                  <a
                    class="socials__link"
                    target="_blank"
                    href="https://github.com/mateholik"
                  >
                    <svg
