  ...
  <section>
    <div class="portfolio">
      <h1 class="portfolio__title">
        <img :src="require('./../assets/img/icons/portfolio.svg')" />Darbų
        pavyzdžiai
      </h1>

      <h2 class="portfolio__subtitle">
        <img :src="require('./../assets/img/icons/check.svg')" />Reprezentacinės
        svetainės
      </h2>
      <div class="portfolio__inner">
        <a
          href="https://www.palanga777.lt/"
          target="_blank"
        ...
        <a
          href="https://emortakiuvalymas.lt/"
          target="_blank"
        ...
        <a
          href="https://betonavimaspanevezyje.lt"
          target="_blank"
      ...
      <div class="portfolio__inner">
        ...
        <a
          href="https://www.beautyboutique.lt"
          target="_blank"
      ...
      <h2 class="portfolio__subtitle">
        <img :src="require('./../assets/img/icons/check.svg')" />Vieno puslapio
        svetainės
      </h2>
      <div class="portfolio__inner">
        <a
          href="https://maxdesign.online/"
          target="_blank"
